...
class ViewUtils {
    ...
    companion object {
        fun addLabelTextView(context: Context, ll: LinearLayout, value: Int) {
            ...
            textView.setTextColor(context.resources.getColorCompat(R.color.alt_text_color))
            textView.setPadding(
        ...
        private fun getStringForLabel(field: IField): Int? {
            return when (field) {
                ...
                Document.IdentityDocument.Field.emitDepartement -> R.string.data_emitDepartment
